  ...
  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      <tr class="">
        ...
        <td class="py-4 px-6 uppercase">{{ $experience->designation }}</td>
        <td class="py-4 px-6">{{ $experience->company }}</td>
        <td class="py-4 px-6">{{ $experience->from }}</td>
        <td class="py-4 px-6">{{ $experience->to }}</td>
        <td class="py-4 px-6">
          <div class="flex">
            ...
            <a href="{{ route('admin.experience.edit',$experience->id) }}"class="text-indigo-600 hover:text-indigo-900">
