...
<div class=" mt-4">
    ...
    <input type="text" name="from" id="from" aria-describedby="from-explanation" class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-96 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-900 dark:focus:border-gray-900" placeholder="Your starting date" value="{{old('from',$experience->from)}}" required>
</div>
<div class=" mt-4">
    <label for="to" class="block mb-2  font-medium text-gray-900 dark:text-white">To</label>
    <input type="text" name="to" id="to" aria-describedby="to-explanation" class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-gray-900 focus:border-gray-900 block w-96 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-900 dark:focus:border-gray-900" placeholder="Your ending date" value="{{old('to',$experience->to)}}" required>
</div>
<div class=" mt-4">
