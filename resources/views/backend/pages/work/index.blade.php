...
<div>
  <div class="flex">
    <div class="flex ">
      <form action="{{ route('admin.work.index') }}" method="GET" role="search">
        <div class="flex input-group">
          ...
          <input type="text" value="{{ $search }}" class=" shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-2" name="search" placeholder="Search here" id="search">
            <a href="{{ route('admin.work.index') }}" class=" mt-1">
      ...
      <tr class="">
        ...
        <td class="py-4 px-6">
          <div class="flex">
            ...
            <a href="{{ route('admin.work.edit',$work->id) }}"class="text-indigo-600 hover:text-indigo-900">
