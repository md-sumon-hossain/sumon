...
<div>
  <div class="flex">
    <div class="flex ">
      <form action="{{ route('admin.skill.index') }}" method="GET" role="search">
        <div class="flex input-group">
          ...
          <input type="text" value="{{ $search }}" class=" shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-2" name="search" placeholder="Search here" id="search">
            <a href="{{ route('admin.skill.index') }}" class=" mt-1">
      ...
      <tr class="">
        ...
        <td class="py-4 px-6">
          <div class="flex">
            ...
            <a href="{{ route('admin.skill.edit',$skill->id) }}"class="text-indigo-600 hover:text-indigo-900">
              <svg class="h-5 w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"/>
                <path fill-rule="evenodd"d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"clip-rule="evenodd"/>
              </svg>
            </a>
            <a href="{{ route('admin.skill.delete',$skill->id) }}" onclick="return confirm('Are you sure you want to delete it ?')">
