  ...
  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    <thead class="text-xs text-gray-900 uppercase dark:text-gray-400">
      <tr>
        ...
        <th scope="col" class="py-3 px-6">Institution</th>
    ...
    <tbody>
      <tr class="">
        ...
        <td class="py-4 px-6 uppercase">{{ $education->degree }}</td>
        <td class="py-4 px-6">{{ $education->institution }}</td>
        <td class="py-4 px-6">{{ $education->from }}</td>
        <td class="py-4 px-6">{{ $education->to }}</td>
        <td class="py-4 px-6">
          <div class="flex">
            ...
            <a href="{{ route('admin.education.edit',$education->id) }}"class="text-indigo-600 hover:text-indigo-900">
